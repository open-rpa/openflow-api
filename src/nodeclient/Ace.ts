...
//     public rights2: BinaryType;
//     constructor() {
//         const arr: Uint8Array = new Uint8Array(this.ace_right_bits / 8);
//         this.rights2 = new Binary(Buffer.from(arr), 0);
//         this.deny = false;
//     }
...
//         bit--;
//         if (NoderedUtil.isNodeJS()) {
//             // if (typeof this.rights !== "string" && this.rights instanceof String) {
//             //     const _bin: Bina
//             //     const _buf: Buffer = this.rights.read(0, this.rights.length());
